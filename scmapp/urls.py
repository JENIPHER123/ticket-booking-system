...
urlpatterns = [
    path('login_admin/', admin.site.urls),
    ...
    re_path('update_event/(?P<id>\d+)/$', views.update_event, name='update_event'),
    re_path('db_update_event/(?P<id>\d+)/$', views.db_update_event, name='db_update_event'),
    re_path('db_delete_event/(?P<id>\d+)/$', views.db_delete_event, name='db_delete_event'),
